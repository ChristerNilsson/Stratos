        ...
        Main(
            ...
            Form(
                ...
                Div(
                    ...
                    Input(type="button", value="↑", id="move-north", title="Flytta cirka 1 meter norrut", aria_label="Flytta norrut"),
                    Input(type="button", value="→", id="move-east", title="Flytta cirka 1 meter österut", aria_label="Flytta österut"),
                    Input(type="button", value="↓", id="move-south", title="Flytta cirka 1 meter söderut", aria_label="Flytta söderut"),
                    Input(type="button", value="←", id="move-west", title="Flytta cirka 1 meter västerut", aria_label="Flytta västerut"),
                    cls="center-arrows",
